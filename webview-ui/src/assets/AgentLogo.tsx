...
const AgentLogo = ({ size = 50, ...props }: AgentLogoProps) => {
	...
	const startAnimation = () => {
		// Disable transition temporarily for instant shrink
		setIsTransitioning(false)
		setScale(0.8)

		// Re-enable transition and start growth after a brief delay
		setTimeout(() => {
	...
	useEffect(() => {
		// Start the initial animation after component mounts
	...
	const animationStyle = {
		...
		transition: isTransitioning ? "transform 1s ease-out" : "none",
		cursor: "pointer",
	}
