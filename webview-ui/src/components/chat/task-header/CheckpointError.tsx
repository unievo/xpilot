...
export const CheckpointError: React.FC<CheckpointErrorProps> = ({
	...
	return (
		<div className="flex items-center justify-center w-full">
			<Alert
				className="rounded-sm border-0 text-xs bg-[var(--vscode-inputValidation-warningBackground)] text-[var(--vscode-inputValidation-warningForeground)] pl-1 pr-1.5 py-1 mb-1 overflow-hidden"
				color="warning"
				description={
