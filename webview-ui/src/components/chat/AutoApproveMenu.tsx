...
const ACTION_METADATA: {
	...
	},
	{
		...
		description: `Allows ${agentName} to execute of safe terminal commands. If the model determines a command is potentially destructive, it will still require approval.`,
	},
	{
