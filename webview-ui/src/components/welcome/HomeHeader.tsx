							...
							<div
								...
								<CollapsibleSection
									...
									<div style={{ marginTop: "-8px", marginBottom: "16px", paddingLeft: "5px" }}>
										...
										window size, total input tokens (tokens sent to the model), total output tokens (tokens
										received from the model), and the maximum context window size the selected provider/model
										supports.
										<br />
										<br />
