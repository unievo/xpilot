...
export const SYSTEM_PROMPT = async (
  ...
  if (isClaude4ModelFamily) {
	...
	return `You are ${agentName}, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.
