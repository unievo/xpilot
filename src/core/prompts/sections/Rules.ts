...
export const RulesPrompt = async (
	cwd: string,
...
- You cannot \`cd\` into a different directory to complete a task. You are always operating from '${cwd.toPosix()}', so be sure to pass in the correct 'path' parameter when using tools that require a path.
...
- Don't start your messages with words like "Great", "Certainly", "Okay", "Sure". You should NOT be conversational in your responses, but rather direct and to the point. For example you should NOT say "Great, I've updated the CSS" but instead something like "I've updated the CSS". It is important you be clear and technical in your messages.
